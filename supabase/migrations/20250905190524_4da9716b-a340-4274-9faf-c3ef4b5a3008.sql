...
-- Insert test projects (fix UUID array casting)
INSERT INTO public.projects (name, description, owner_id, members, status) VALUES
('Design System Documentation', 'Comprehensive documentation and examples for our company design system', 'ff7e510a-7682-411e-af2c-b3a7b68a21d2'::uuid, ARRAY['ff7e510a-7682-411e-af2c-b3a7b68a21d2'::uuid], 'active'),
('React Best Practices Guide', 'Collaborative guide for React development standards', 'ff7e510a-7682-411e-af2c-b3a7b68a21d2'::uuid, ARRAY['ff7e510a-7682-411e-af2c-b3a7b68a21d2'::uuid], 'active');
